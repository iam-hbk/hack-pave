...
import { ModelPreviewProps } from "@/lib/svg-model-types";
    ...
    return (
      ...
      >
        ...
        <OrbitControls
          ...
          maxDistance={400}
          enablePan={true}
          enableZoom={enableZoom !== undefined ? enableZoom : true}
          enableRotate={true}
          target={[0, 0, 0]}
          minPolarAngle={minPolarAngle !== undefined ? minPolarAngle : 0}
          maxPolarAngle={maxPolarAngle !== undefined ? maxPolarAngle : Math.PI}
        />
      </Canvas>
    );
  }
